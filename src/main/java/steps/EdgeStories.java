...
public class EdgeStories extends JUnitStories {
    ...
    StoryReporterBuilder reporterBuilder = new StoryReporterBuilder()
            .withCodeLocation(codeLocationFromClass(EdgeStories.class)).withFailureTrace(true)
    ...
    public Configuration configuration() {
        return new SeleniumConfiguration().useSeleniumContext(seleniumContext)
                ...
                .useStoryLoader(new LoadFromClasspath(EdgeStories.class))
