# edgeJB-BDD using Java and Spring

This project uses JBehave 3.x and Selenium 2.x to test 
Was made based in Jbehave guide: 
<img src="http://jbehave.org/reference/preview/images/jbehave-logo.png" alt="JBehave logo" align="right" />

## Running the stories

This will run the build and execute the tests with the command:

    mvn clean install 

You should see Firefox (installed on your system)
